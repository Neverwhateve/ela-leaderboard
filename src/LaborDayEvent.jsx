        ...
        <div className="bg-gradient-to-br from-warning/10 via-primary/5 to-success/10 rounded-acnh-lg p-6 shadow-acnh-lg border-2 border-warning/30 relative overflow-hidden mb-8">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-lg text-textSecondary mb-4">
              {laborDayData.eventDateRange}
            </p>
            <div className="inline-block glassmorphism px-6 py-3 rounded-acnh">
              <p className="text-sm text-textSecondary">活动说明</p>
              <p className="text-primary font-semibold">假期特别任务积分 · 不计入总积分，单独计算排名！</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-acnh-lg p-6 shadow-acnh-lg">
          <h2 className="text-2xl font-bold text-warning mb-6 text-center">🏆 活动积分排行榜</h2>
